    ...
    <div className="client-gemini flex h-full rounded-xl overflow-hidden border relative">
      ...
      <div className="w-[260px] bg-[var(--client-sidebar)] flex flex-col border-r">
              ...
              return (
                <div
                  ...
                  className={`px-3 py-2.5 rounded-lg text-sm cursor-pointer transition-colors ${
                    isActive
                      ? "bg-[#4285f4]/[0.08] text-[var(--client-text)] font-medium"
                      : "text-[var(--client-muted)] hover:bg-black/[0.03]"
                  }`}
                >
                  <div className="flex items-center gap-2">
                    {isActive && (
                      <div className="w-1.5 h-1.5 rounded-full bg-[#4285f4] shrink-0" />
                    )}
        ...
        <div className="p-3 border-t">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-black/[0.03] transition-colors cursor-pointer">
            <div className="w-8 h-8 rounded-full bg-[#4285f4] flex items-center justify-center text-xs font-bold text-white">
              AM
            </div>
      ...
      <div className="flex-1 flex flex-col bg-[var(--client-bg)] min-h-0">
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 cursor-pointer hover:opacity-80">
              ...
              <span className="text-xs text-[var(--client-muted)] bg-black/[0.04] px-1.5 py-0.5 rounded">2.5 Pro</span>
            ...
            {/* Connected UCP merchant */}
            <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[#4285f4]/[0.06] border border-[#4285f4]/15 cursor-pointer hover:bg-[#4285f4]/10 transition-colors">
              <div className="w-4 h-4 rounded bg-[#4285f4]/15 flex items-center justify-center">
                <span className="text-[8px] font-bold text-[#4285f4]">SV</span>
              </div>
              <span className="text-xs font-medium text-[#4285f4]">StyleVault</span>
              <span className="text-[9px] text-[#4285f4]/60 font-medium">UCP</span>
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
              <svg className="w-3 h-3 text-[#4285f4]/60" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
            </div>
          </div>
        ...
        <div className="px-4 pb-4 pt-2">
          <div className="rounded-2xl bg-[var(--client-input)] border px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <button className={`w-8 h-8 rounded-full flex items-center justify-center cursor-pointer shrink-0 transition-all duration-200 ${
                sendFlash ? "bg-[#4285f4] text-white scale-90" : userTyping.typing ? "bg-[#4285f4] text-white" : "bg-black/5 text-[var(--client-muted)]"
              }`}>
          ...
          <p className="text-[10px] text-[var(--client-muted)] text-center mt-2">Gemini can make mistakes, so double-check it.</p>
        </div>
      </div>
